...
export interface Project { id: string | number; slug: string; title: string; excerpt?: string; description?: string; categories?: ProjectCategory[]; images?: ProjectImage[]; year?: number; location?: string; }
