declare module 'three' {
  ...
  export class Material { opacity: number; clippingPlanes: Plane[] | null; dispose(): void; }
  export class Object3D { name: string; visible: boolean; children: Object3D[]; position: Vector3; scale: Vector3; rotation: { x: number; y: number; z: number }; castShadow: boolean; receiveShadow: boolean; lookAt(x: number, y: number, z: number): void; traverse(callback: (object: Object3D) => void): void; }
